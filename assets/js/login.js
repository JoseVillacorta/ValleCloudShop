...
const edadRegistro = document.querySelector('#edadRegistro');
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    registrarse.addEventListener('click', function(){
        if (nombreRegistro.value == '' || correoRegistro.value == '' || claveRegistro == '') {
            Swal.fire({
                title: "Aviso?",
            ...
            formData.append('edad', edadRegistro.value);
                ...
                if(this.readyState == 4 && this.status == 200){     
                    ...
                    <div class="card h-100">
                        ...
                        <a href="${ base_url + 'principal/detail/' +  producto.id}">
                            <img src="${ producto.imagen }" class="card-img-top" alt="${ producto.namePro }?>">
                        </a>
                        <div class="card-body">
                            ...
                            <a href="${ base_url + 'principal/detail/' +  producto.id}" class="h2 text-decoration-none text-dark">${ producto.namePro }></a>
                            <p class="card-text">
