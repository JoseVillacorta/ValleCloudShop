    ...
    <div class="container">
        <div class="row align-items-center py-5">
            <div class="col-md-8 text-white">
                ...
                <p>
                    En ValleCloudShop, estamos dedicados a brindarte una experiencia de
                    compra en línea que sea tanto única como personalizada. Como estudiantes de
                    informática, hemos desarrollado esta tienda virtual con el objetivo de combinar
                    tecnología innovadora con una interfaz fácil de usar para ayudarte a encontrar
