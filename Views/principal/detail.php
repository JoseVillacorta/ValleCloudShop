        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?php echo $data['producto']['namePro']; ?></h1>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $data['producto']['nameCat']; ?></strong></p>
                                </li>
                            </ul>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row text-left p-2 pb-3">
                <h4>Productos que te podrian interesar</h4>
            </div>
                ...
                <?php foreach($data['relacionados'] as $producto){ ?>
                    <div class="p-2 pb-3">
                        <div class="product-wap card rounded-0">
                            ...
                            <div class="card-body">
                                <a href="<?php echo BASE_URL . 'principal/detail/' . $producto['id']; ?>" class="h3 text-decoration-none"><?php echo $producto['namePro']; ?></a>
