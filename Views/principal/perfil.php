...
<div class="container py-5">
    <?php if ($data['verificar']['verify'] == 1) { ?>
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="completados-tab" data-bs-toggle="tab" data-bs-target="#completados-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Pagados</button>
            </li>
        </ul>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body text-center">
                                <!-- CAMBIAR LOGO DE LA PAGINA-->
                                <img class="img-thumbnail rounded-circle" src="<?php echo BASE_URL . 'assets/img/default.png'; ?>" alt="" width="150">
                                <hr>
